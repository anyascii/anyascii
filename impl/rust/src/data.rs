...
pub fn block(block_num: u32) -> &'static [[u8; 3]] {
    let b: &'static [u8] = match block_num {
        ...
        0x120 => include_bytes!("data/120"),
        0x122 => include_bytes!("data/122"),
        0x123 => include_bytes!("data/123"),
        ...
        0x135 => include_bytes!("data/135"),
        0x136 => include_bytes!("data/136"),
        0x137 => include_bytes!("data/137"),
        0x138 => include_bytes!("data/138"),
        0x139 => include_bytes!("data/139"),
        0x13a => include_bytes!("data/13a"),
        0x13b => include_bytes!("data/13b"),
        0x13c => include_bytes!("data/13c"),
        0x13d => include_bytes!("data/13d"),
        0x13e => include_bytes!("data/13e"),
        0x13f => include_bytes!("data/13f"),
        0x140 => include_bytes!("data/140"),
        0x141 => include_bytes!("data/141"),
        0x142 => include_bytes!("data/142"),
        0x143 => include_bytes!("data/143"),
        0x144 => include_bytes!("data/144"),
        0x145 => include_bytes!("data/145"),
        0x146 => include_bytes!("data/146"),
        0x161 => include_bytes!("data/161"),
        0x168 => include_bytes!("data/168"),
        0x169 => include_bytes!("data/169"),
        0x16a => include_bytes!("data/16a"),
        0x16b => include_bytes!("data/16b"),
        0x16d => include_bytes!("data/16d"),
        ...
        0x1cc => include_bytes!("data/1cc"),
        0x1cd => include_bytes!("data/1cd"),
        0x1ce => include_bytes!("data/1ce"),
        ...
        0x1d8 => include_bytes!("data/1d8"),
        0x1d9 => include_bytes!("data/1d9"),
        0x1da => include_bytes!("data/1da"),
        ...
        0x1e5 => include_bytes!("data/1e5"),
        0x1e6 => include_bytes!("data/1e6"),
        ...
        0x2ec => include_bytes!("data/2ec"),
        0x2ed => include_bytes!("data/2ed"),
        0x2ee => include_bytes!("data/2ee"),
        ...
        0x31a => include_bytes!("data/31a"),
        0x31b => include_bytes!("data/31b"),
        0x31c => include_bytes!("data/31c"),
        0x31d => include_bytes!("data/31d"),
        0x31e => include_bytes!("data/31e"),
        0x31f => include_bytes!("data/31f"),
        0x320 => include_bytes!("data/320"),
        0x321 => include_bytes!("data/321"),
        0x322 => include_bytes!("data/322"),
        0x323 => include_bytes!("data/323"),
        0x329 => include_bytes!("data/329"),
        0x32a => include_bytes!("data/32a"),
        0x32c => include_bytes!("data/32c"),
        0x332 => include_bytes!("data/332"),
